...
Module Program
    Public goFS As New FileSystemObject
                    ...
                    Do While True
                        ...
                        Select Case Console.ReadKey().Key
                            ...
                            Case ConsoleKey.B
                                ...
                                End If
                                Dim oFolder As Folder = goFS.GetFolder(strFolderPath)
                        ...
                        Select Case Console.ReadKey().Key
                            ...
                            Case ConsoleKey.A
                                ...
                                Else
                                    ...
                                    oTextStream = goFS.OpenTextFile(strFilePath, FileSystemObject.pIOMode.ForReading, False)
                                    If goFS.LastErr <> "" Then
                                        Console.WriteLine(goFS.LastErr)
                                    Else
                            ...
                            Case ConsoleKey.B
                                ...
                                Dim oTextStream As TextStream
                                Console.WriteLine("OpenTextFile(" & strFilePath & ")...")
                                oTextStream = goFS.OpenTextFile(strFilePath, FileSystemObject.pIOMode.ForWriting, True)
                                If goFS.LastErr <> "" Then
                                    Console.WriteLine(goFS.LastErr)
                                Else
